...
export default function LojaConfiguracoesPage({
  ...
  useEffect(() => {
    ...
    const saved = loadStorefrontSettings(storageScope);
    ...
    const readData = async () => {
      try {
        ...
        if (settingsResponse.ok) {
          ...
          saveStorefrontSettings(merged, storageScope);
  ...
  const handleSave = async () => {
    ...
    saveStorefrontSettings(settings, storageScope);
    ...
    try {
      ...
      saveStorefrontSettings(synced, storageScope);
